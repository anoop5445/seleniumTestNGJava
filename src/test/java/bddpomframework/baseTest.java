...
public class baseTest {
	...
	public void beforeTest() {
		htmlReporter = new ExtentHtmlReporter(path: System.getProperty("user.dir")+File.separator+"Reports"+ File.separator+"AutomationReport.html");
		...
		extent.setSystemInfo(k:"Automation Test Engineer", v:"Anoop Singh Tomar");
	} 
	...
	public void setupDriver(String browserName) {
		if(browserName.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "F:/Anoop New/wrkspce/bddpomframework/drivers/chromedriver.exe");
